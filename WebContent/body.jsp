...
<div style="height: 90px">
	...
	<nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
		<a class="navbar-brand" href="#">Librarian's Manager</a>
			...
			<ul class="navbar-nav mr-auto">
				<li class="nav-item dropdown"><a
					...
					<div class="dropdown-menu">
						...
						<a class="dropdown-item" href="#">返却延滞者の確認</a>
					</div></li>
				<li class="nav-item dropdown"><a
					class="nav-link dropdown-toggle" href="" data-toggle="dropdown"
					aria-haspopup="true" aria-expanded="false">資料管理</a>
					<div class="dropdown-menu">
						<a class="dropdown-item" href="#">貸出</a> <a class="dropdown-item"
							href="#">返却</a> <a class="dropdown-item" href="#">追加</a> <a
							class="dropdown-item" href="#">検索</a>
					</div></li>
				<li class="nav-item dropdown"><a
					class="nav-link dropdown-toggle" href="" data-toggle="dropdown"
